...
public class VendaCompraLojaVirtual implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "forma_pagamneto_id", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "forma_pagamneto_fk"))
	...
	public FormaPagameto getFormapagamento() {
		return formapagamento;
	}

	public void setFormapagamento(FormaPagameto formapagamento) {
